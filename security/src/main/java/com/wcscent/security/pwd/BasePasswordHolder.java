 ...
 * @author hanpengfei
 */
public abstract class BasePasswordHolder {

    private AbstractPassword password;

    public void changePassword(String currentPassword, String changedPassword)
            throws PasswordIncorrectException {
        password = password.change(currentPassword, changedPassword);
    }

    protected BasePasswordHolder(AbstractPassword password) {
